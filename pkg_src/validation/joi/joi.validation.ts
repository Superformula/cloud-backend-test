 ...
 * @returns if the schema is not validated, we'll throw an error, otherwise the given payload will be returned
 */
// eslint-disable-next-line
export const validate = <T>(schema: any, body: string): T =>
{
	try {
