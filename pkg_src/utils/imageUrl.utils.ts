...
export const getImageUrl = (imageUrl: string | null): string =>
{
	...
	else
	{
		...
		else
		{
			...
			if (parts.length === 2)
				return `https://images.unsplash.com/photo-${parts[0]}?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=400&ixid=${parts[1]}&ixlib=rb-1.2.1&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=400`
